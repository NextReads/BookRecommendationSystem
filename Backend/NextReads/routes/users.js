...
router.delete('/:bookId/wanttoread',[auth],userController.removeFromWantToRead)
router.delete('/:bookId/read',[auth],userController.removeFromRead)
router.post('/:bookId/currentbook',[auth],userController.setCurrentBook)
router.get('/currentbook',[auth],userController.getCurrentBook)
